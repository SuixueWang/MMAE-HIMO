...
def get_args_parser_pretrain():
    ...
    parser.add_argument('--batch_size', default=81, type=int,
    ...
    parser.add_argument('--data_dir', default='./dataset/tcga_lihc_splits.pkl',
...
def get_args_parser_finetune():
    ...
    parser.add_argument('--batch_size', default=260, type=int,
                        help='Batch size per GPU (effective batch size is batch_size * accum_iter * # gpus')
